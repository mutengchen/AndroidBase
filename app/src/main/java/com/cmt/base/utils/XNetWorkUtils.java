...
public class XNetWorkUtils {
     ...
     */
    public static NetworkInfo getCurrentNetState(){
    ...
    public static boolean isConnect(){
        NetworkInfo info = getCurrentNetState();
    ...
    /**
     * 通过ping 某个网站去判断是否真正可以上网，为了防止连上wifi无网的状态
     * @return
     */
    public static final boolean ping(){
        try {
            String ip = "www.baidu.com";
            Process p = Runtime.getRuntime().exec("ping -c 3 -w 100"); //通过jvm去调用手机本地的ping程序，每隔100ms去访问百度一次，总共三次
