...
public class XDensityUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = AFrame.getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = AFrame.getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenWidth() {
        return AFrame.getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return AFrame.getDisplayMetrics().heightPixels;
    }
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) AFrame.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = AFrame.getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = AFrame.getResources();
